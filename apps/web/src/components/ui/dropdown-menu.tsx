...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      // Deviation from upstream shadcn, which ships `cursor-default` here after
      // native desktop menus. Ours are web affordances and hovering one should
      // say it is clickable. Re-adding this component with the CLI will undo it.
      className={cn(
